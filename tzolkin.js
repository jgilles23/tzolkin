...
class TzolkinGame {
    ...
    checkPlaceWorker(playerNumber, wheel, spaceNumber) {
...
class TileBase {
    constructor(game, parentDom, topText = "", bottomText = "") {
        this.game = game;
        let template = document.getElementById("tile-template");
...
//Setup player areas
area = document.getElementById("player-0-resources");
...
area = document.getElementById("player-0-religion-technology");
new TrackSpace(game, area, 0, "religion", 0, ["-1p", "0p", "2p s", "4p", "6p s", "7p", "8p *"], "religion-0-color");
new TrackSpace(game, area, 0, "religion", 1, ["-2p", "0p", "1p", "2p g", "4p", "6p g", "9p", "12p", "13p *"], "religion-1-color");
new TrackSpace(game, area, 0, "religion", 2, ["-1p", "0p", "1p w", "3p", "5p w", "7p k", "9p", "10p *"], "religion-2-color");
new TrackSpace(game, area, 0, "technology", 0, ["", "+1/0c", "+1/1c tile", "+3/1c tile", "R"], "none");
new TrackSpace(game, area, 0, "technology", 1, ["", "+w", "+w/s", "+w/s/g", "2x"], "none");
new TrackSpace(game, area, 0, "technology", 2, ["", "B: 1c", "B: 1c 2p", "B: 1c 2p -x", "3p"], "none");
new TrackSpace(game, area, 0, "technology", 3, ["", ">C", ">C x:R", ">C x:R +k", "k"], "none");
